#!/bin/bash
# setup-rpp-linux.sh
# Setup-Skript für das RPP-Projekt auf Linux
...
if ! command -v node &> /dev/null; then
  ...
  echo "Bitte Node.js 20 LTS oder 22 LTS installieren:"
  echo "  https://nodejs.org/"
  echo "  oder (Ubuntu/Debian): curl -fsSL https://deb.nodesource.com/setup_20.x | sudo -E bash - && sudo apt-get install -y nodejs"
  exit 1
fi
