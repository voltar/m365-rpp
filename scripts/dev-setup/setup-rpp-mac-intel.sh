#!/bin/bash
# setup-rpp-mac-intel.sh
# Setup-Skript für das RPP-Projekt auf einem Intel-basierten Mac
...
echo "=============================================="
echo "  RPP Projekt Setup – Intel Mac"
...
if ! command -v dotnet &> /dev/null; then
  ...
  echo "Bitte .NET 8 SDK (x64) installieren:"
...
if ! command -v node &> /dev/null; then
  ...
  echo "Bitte Node.js 20 LTS oder 22 LTS (x64) installieren:"
